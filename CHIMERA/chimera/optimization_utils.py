...
def Mstep(y,yd,ys,x,tx,xd,xs,P,params,config):
    ...
    if config['transform'] == 'affine':
        from CHIMERA.chimera.Mstep_affine import solve_sigsq,solve_delta,solve_T,solve_t
    elif config['transform'] == 'duo':
        from CHIMERA.chimera.Mstep_duo import solve_sigsq, solve_delta, solve_T, solve_t
    else:
        from CHIMERA.chimera.Mstep_trans import solve_sigsq, solve_delta, solve_T, solve_t
